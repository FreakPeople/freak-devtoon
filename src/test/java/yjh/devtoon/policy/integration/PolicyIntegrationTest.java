...
//            CookiePolicyEntity savedCookiePolicyEntity = cookiePolicyRepository.save
//            (cookiePolicyEntity);
...
//            BadWordsPolicyEntity savedBadWordsPolicyEntity = badWordsPolicyRepository.save
//            (badWordsPolicyEntity);
...
//                    .andExpect(status().isOk())
//                    .andExpect(jsonPath("$.statusMessage").value("성공"))
//                    .andExpect(jsonPath("$.data.policyDetailsInfo[0].id").value
//                    (savedCookiePolicyEntity.getId()))
//                    .andExpect(jsonPath("$.data.policyDetailsInfo[0].type").value
//                    ("CookiePolicyEntity"))
//                    .andExpect(jsonPath("$.data.policyDetailsInfo[1].id").value
//                    (savedBadWordsPolicyEntity.getId()))
//                    .andExpect(jsonPath("$.data.policyDetailsInfo[1].type").value
//                    ("BadWordsPolicyEntity"));
//
//        }
//
